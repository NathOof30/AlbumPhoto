...
@section('content')
    ...
    <div class="error-404-sad-face">
        <span>:(</span>
    </div>
    <div class="comforting-message text-center">
        <p>Mais ne vous inquiétez pas, vous pouvez toujours revenir à la liste des albums et continuer à explorer vos photos préférées !</p>
    </div>
    <div class="terror">
        <pre>
